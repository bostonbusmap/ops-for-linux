...
#
CFLAGS="-mms-bitfields -DXTHREADS -D_REENTRANT -DXUSE_MTSAFE_API -I$PREFIX/include/gtk-2.0 -I$PREFIX/lib/gtk-2.0/include -I$PREFIX/include/atk-1.0 -I$PREFIX/include/pango-1.0 -I$PREFIX/include/glib-2.0 -I$PREFIX/lib/glib-2.0/include -I$PREFIX/include"
